    ...
    <div className="container mt-4">
      ...
      <div className="card">
        ...
        <ul className="list-group list-group-flush">
          {assignments.length === 0 && <li className="list-group-item">No assignments found for this course.</li>}
          {assignments.map((assignment) => (
            <li className="list-group-item d-flex align-items-center position-relative" key={assignment._id}>
